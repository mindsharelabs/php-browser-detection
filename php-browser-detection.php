...
if (!function_exists('browser_supports_javascript')) :
	/**
...
if (!function_exists('browser_supports_cookies')) :
	/**
...
if (!function_exists('browser_supports_css')) :
	/**
